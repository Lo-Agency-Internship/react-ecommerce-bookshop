...
export default function SignUp() {
    return (
        <div className='w-screen'>
            <div className='w-screen flex flex-col justify-center relative items-center'>
                <img className='w-8/12 h-auto' src={SignUpImage} alt="" />
                <form className='max-w-[400px] w-full mx-auto bg-gray-900 p-8 rounded-lg absolute'>
